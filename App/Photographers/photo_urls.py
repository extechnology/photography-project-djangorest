...
urlpatterns = [
    ...
    # -------------------------------------------------------------------------
    # Photographer Profiles & Studio Branding
    # -------------------------------------------------------------------------
    ...
    # Photographer Posts
    # -------------------------------------------------------------------------
    path('posts/', PhotographerPostListView.as_view(), name='post-list-base'),
    ...
    path('posts/<int:pk>/', PhotographerPostDetailView.as_view(), name='post-detail-base'),
    ...
    path('feedbacks/', PostFeedbackListView.as_view(), name='feedbacks-base-list'),
    path('feedbacks/create/', PostFeedbackCreateView.as_view(), name='feedbacks-base-create'),
    ...
    # -------------------------------------------------------------------------
    path('notifications/', NotificationListView.as_view(), name='notification-base-list'),
